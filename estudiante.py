...
class Estudiante(object):
    def __init__(self, provincia:str, puntaje_matematica: float, puntaje_lengua: float, puntaje_nse: float, ambito: ambitoType, sector: sectorType):
        ...
        self.ambito: ambitoType = ambito
        self.sector: sectorType = sector
        pass
